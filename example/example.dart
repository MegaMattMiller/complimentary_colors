...
class Example
{
  ...
  Example()
  {
    ...
    HexColor complimentaryHexColor = CalculateComplimentaryColor.fromHex(givenHexColor);

    //Get the complimentary color of (270, 100, 100);
    HslColor complimentaryHslColor = CalculateComplimentaryColor.fromHsl(givenHslColor);
  }
}